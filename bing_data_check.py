...
def check_date_in_file(parent_folder: str):
    ...
    if changes_made:
        print('Code completed successfully. Changes were made.')
    else:
        print('Code completed successfully. No changes were made.')
...
def check_all_fields_in_file(parent_folder: str):
    check_date_in_file(parent_folder)
    las_folder = os.path.join(parent_folder, 'las')
    for file_name in os.listdir(las_folder):
        if file_name.endswith('.las'):
            file_path = os.path.join(las_folder, file_name)
